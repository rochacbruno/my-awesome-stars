...
- [lovelydinosaur/django-ajax-messages](https://github.com/lovelydinosaur/django-ajax-messages) - NO LONGER MAINTAINED
...
- [canonical/k8s-dqlite](https://github.com/canonical/k8s-dqlite) - Dqlite for Kubernetes
...
- [docker-archive-public/docker.libcompose](https://github.com/docker-archive-public/docker.libcompose) - *Unmaintained/Deprecated* An experimental go library providing Compose-like functionality
...
- [lucadealfaro/plainbook](https://github.com/lucadealfaro/plainbook) - Notebooks, in natural language.  A replacement for Jupyter notebooks in plain English.
...
- [lobovkin/forward-domain](https://github.com/lobovkin/forward-domain) - Forward Domains, completely free and open source.
...
- [mbwilding/NeoSpleen](https://github.com/mbwilding/NeoSpleen) - A modern monospaced font inspired by Spleen.
...
- [frenck/python-elgato](https://github.com/frenck/python-elgato) - Asynchronous Python client for Elgato Key Lights.
...
- [flipbit03/main](https://github.com/flipbit03/main) - For those that think `if __name__ = "__main__"` is ugly (this is a joke)
...
- [bun9000/TwitchShoutoutBot](https://github.com/bun9000/TwitchShoutoutBot) - A bot that shouts out a twitch team member! Uses chat + tts
...
- [inkstitch/pystitch](https://github.com/inkstitch/pystitch) - libembroidery/EmbroideryFormats converted to python
...
- [ikreymer/webarchiveplayer](https://github.com/ikreymer/webarchiveplayer) - NOTE: This project is no longer being actively developed.. Check out https://replayweb.page / https://github.com/webrecorder/replayweb.page for latest tool for viewing web archives directly in the bro
...
- [pallets-eco/flask-rq](https://github.com/pallets-eco/flask-rq) - RQ (Redis Queue) integration for Flask and Quart applications.
...
- [Goldaracena/colorschemeswapper-plasmoid](https://github.com/Goldaracena/colorschemeswapper-plasmoid) - A KDE plasmoid to swap between any two given color schemes.
...
- [kristoferlund/ostt](https://github.com/kristoferlund/ostt) - Open source voice-to-text for the terminal. Record from a hotkey, transcribe with any provider, pipe to AI or shell commands.
...
- [Open-Cyber-Range/Deputy](https://github.com/Open-Cyber-Range/Deputy) - A digital library implementation intended for storing cyber exercise artifacts.
- [Canop/codesort](https://github.com/Canop/codesort) - codesort sorts code
...
- [ricott1/asterion](https://github.com/ricott1/asterion) - Find your way out of a dangeroussh labyrinth
...
- [indexmap-rs/equivalent](https://github.com/indexmap-rs/equivalent) - Rust traits for key comparison in maps.
- [mitsuhiko/argument](https://github.com/mitsuhiko/argument) - I want to have an argument
- [MathiasPius/crates-lsp](https://github.com/MathiasPius/crates-lsp) - Language Server implementation for Cargo.toml
- [kamu-data/dill-rs](https://github.com/kamu-data/dill-rs) - Runtime dependency injection library for Rust
...
- [rilluard/aprendendo-rust](https://github.com/rilluard/aprendendo-rust) - 
...
- [UndefinedChai/hostess](https://github.com/UndefinedChai/hostess) - Command-line utility for managing your /etc/hosts file built with rust
...
- [elementary/code](https://github.com/elementary/code) - Code editor designed for elementary OS
