...
- [ffunenga/virtuallinks](https://github.com/ffunenga/virtuallinks) - A Python simulator of file system links.
...
- [estin/simple-completion-language-server](https://github.com/estin/simple-completion-language-server) - Language server to enable word completion for Helix editor
...
- [build-with-me/vscode-twitch-themer](https://github.com/build-with-me/vscode-twitch-themer) - A Visual Studio Code extension that listens to Twitch chat and allows viewers to change the streamers VS Code theme.
